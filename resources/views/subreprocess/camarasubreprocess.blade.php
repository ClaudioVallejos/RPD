    ...
    <div class="responsive">
        <div class=" ">    
                 ...
                 <div class="table-responsive">
                   <table class="table table-responsive" id="laravel_datatable17" style="width:100%"> 
                       <thead>
                           <tr>
...
<script>
    ...
    $('#laravel_datatable17 thead tr').clone(true).appendTo( '#laravel_datatable17 thead' );
    $('#laravel_datatable17 thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#laravel_datatable17').DataTable({
